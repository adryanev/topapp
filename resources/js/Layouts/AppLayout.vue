        ...
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <jet-nav-link :active="$page.currentRouteName == 'dashboard'" href="/dashboard">
                                Dashboard
                            </jet-nav-link>
                        </div>
                    </div>
                        ...
                        <div class="ml-3 relative">
                            <jet-dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <jet-dropdown-link v-if="$page.jetstream.hasApiFeatures" href="/user/api-tokens">
                                        API Tokens
                                    </jet-dropdown-link>
                                    ...
                                    <template v-if="$page.jetstream.hasTeamFeatures">
                                        ...
                                        <jet-dropdown-link v-if="$page.jetstream.canCreateTeams" href="/teams/create">
                                            Create New Team
                                        </jet-dropdown-link>
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    <jet-responsive-nav-link :active="$page.currentRouteName == 'dashboard'" href="/dashboard">
                        Dashboard
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    ...
                    <div class="mt-3 space-y-1">
                        <jet-responsive-nav-link :active="$page.currentRouteName == 'profile.show'"
                                                 href="/user/profile">
                            Profile
                        </jet-responsive-nav-link>
                        ...
                        <template v-if="$page.jetstream.hasTeamFeatures">
                            ...
                            <!-- Team Settings -->
                            <jet-responsive-nav-link :active="$page.currentRouteName == 'teams.show'"
                                                     :href="'/teams/' + $page.user.current_team.id">
                                Team Settings
                            </jet-responsive-nav-link>

                            <jet-responsive-nav-link :active="$page.currentRouteName == 'teams.create'"
                                                     href="/teams/create">
                                Create New Team
                            </jet-responsive-nav-link>
                            ...
                            <template v-for="team in $page.user.all_teams">
                                <form @submit.prevent="switchToTeam(team)">
                                    <jet-responsive-nav-link as="button">
                                        <div class="flex items-center">
                                            <svg v-if="team.id == $page.user.current_team_id"
                                                 class="mr-2 h-5 w-5 text-green-400" fill="none" stroke="currentColor"
